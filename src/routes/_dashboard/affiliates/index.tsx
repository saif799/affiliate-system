    ...
    <div dir="rtl" className="min-h-screen bg-slate-50 p-4 sm:p-6 space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl px-4 py-2.5 text-sm transition-colors shadow-sm shadow-violet-200 w-full sm:w-auto shrink-0"
        >
          <svg
            width="15"
            height="15"
