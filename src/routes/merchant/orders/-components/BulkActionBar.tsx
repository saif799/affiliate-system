  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <div className="hidden h-3.5 w-px bg-blue-200 sm:block" />
        <button
          onClick={onPrint}
      ...
      <button
        onClick={onClear}
        className="flex shrink-0 items-center gap-1 self-start text-xs text-blue-500 hover:text-blue-700 sm:self-auto"
      >
        <X size={13} />
        إلغاء التحديد
      </button>
