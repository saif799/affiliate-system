      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mb-5 flex items-center justify-between px-2">
          <div className="flex items-center gap-2.5">
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-lg text-white ${brand.colorClass}`}
            >
        ...
        <div className="mb-4 flex items-center gap-2.5 rounded-lg bg-gray-100 px-3 py-2">
          <div
            className={`flex h-7 w-7 items-center justify-center rounded-md ${user.avatarBg} ${user.avatarFg}`}
          >
            <User size={14} />
          </div>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              className={`flex h-7 w-7 items-center justify-center rounded-lg text-white ${brand.colorClass}`}
            >
